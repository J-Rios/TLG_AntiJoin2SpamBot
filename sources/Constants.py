...
TEXT = {
    'EN' : {
        ...
        'MSG_SPAM_DETECTED_CANT_REMOVE' : \
            'Spam message detected, but I have not permission for remove it. Please, give me ' \
        ...
        'USER_CANT_ADD_BOT_CANT_KICK' : \
            ...
            '\n' \
            'User {} has added the Bot {}, I try to kick the Bot, but I have not permission ' \
        ...
        'USER_LONG_NAME_JOIN_CANT_REMOVE' : \
            'Anti-Spam Warning:\n' \
            '————————————————\n' \
            'An user with a name that is too long, has joined the chat. But I have not ' \
        ...
        'USER_URL_NAME_JOIN_CANT_REMOVE' : \
            'Anti-Spam Warning:\n' \
            '————————————————\n' \
            'An user with a name that contains an URL has joined the chat. But I have not ' \
            'permission for remove the message. Please, give me administration privileges for ' \
            'delete messages ;)\n' \
            '\n' \
            '"{}" joined the chat.',
    ...
    'ES' : {
        'START' : \
            'Soy un Bot que se enfrenta a aquellos Spammers que se unen a un grupo para ' \
