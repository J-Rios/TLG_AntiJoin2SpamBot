...
CONST = {
    ...
    'F_GROUPS' : 'groups.json', # Allowed groups JSON file name
...
TEXT = {
    'EN' : {
        ...
        'ANTI-SPAM_BOT_ADDED_TO_GROUP_NOT_ALLOW' : \
            ...
            'and unwanted info.\n' \
            '\n' \
            'This Bot account own to @JoseTLG, who is hosting the Bot code.\n' \
            '\n' \
    ...
    'ES' : {
        ...
        'ANTI-SPAM_BOT_ADDED_TO_GROUP_ALLOW' : \
            'Hola, soy un Bot que se enfrenta a los Spammers que se unen a un grupo para ' \
