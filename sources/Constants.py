...
TEXT = {
    'EN' : {
        ...
        'MSG_SPAM_DETECTED_1' : \
            '\n\nNew members need to wait {} hours and publish {} messages to be allowed to ' \
            'publish URLs in messages.',
    ...
    'ES' : {
        ...
        'MSG_SPAM_DETECTED_1' : \
            '\n\nLos nuevos usuarios necesitan esperar {} horas y escribir más de {} mensajes ' \
            'para poder escribir mensajes que contengan URLs.',
