...
TEXT = {
    'EN' : {
        ...
        'HELP' : \
            ...
            '\n' \
            '- To preserve a clean group, I auto-remove my messages after {} minutes (except ' \
            'Spam detection messages and Admins calls).\n' \
            '\n' \
            '- Configuration and enable/disable commands just can be used by the group ' \
            'Administrators.\n' \
            '\n' \
            '- You can change the language that I spoke using the command /language.\n' \
            '\n' \
        ...
        'MSG_SPAM_DETECTED_1' : \
            '\n\nNew members need to write {} messages and wait {} hours to be allowed to ' \
            'publish URLs in messages.',
        ...
        'CALL_WHEN_SPAM_ENABLE' : \
            'Call Admins when spam is detected enabled.',

        'CALL_WHEN_SPAM_DISABLE' : \
            'Call Admins when spam is detected disabled.',
        ...
        'ABOUT_MSG' : \
            'This is an open-source GPL-GNU Bot developed by the telegram user {}. You can ' \
            'check the code here:\n{}',
    ...
    'ES' : {
        ...
        'HELP' : \
            ...
            '\n' \
            '- Para mantener limpio el grupo, elimino mis mensajes pasados {} minutos (salvo ' \
            'mensajes relacionados con la detección de Spam y llamada a Administradores).\n' \
            '\n' \
        ...
        'SET_HOURS_NOT_ARG' : \
            'No se proporcionó ningún tiempo. Tienes que especificar cuántas horas quieres que un nuevo ' \
            'usuario deba esperar antes de poder publicar mensajes que contengan URLs.\n' \
            '\n' \
            'Ejemplo (5h o 24h):\n' \
            '/set_hours 5\n' \
            '/set_hours 24',
        ...
        'MSG_SPAM_DETECTED_1' : \
            '\n\nLos nuevos usuarios necesitan escribir más de {} mensajes y esperar {} horas ' \
            'para poder publicar mensajes que contengan URLs.',

        'CALLING_ADMINS' : \
            '\n\nLlamando a los Admins:\n{}',

        'CALL_WHEN_SPAM_ENABLE' : \
            'Activada la llamada a los Admins cuando se detecta spam.',

        'CALL_WHEN_SPAM_DISABLE' : \
            'Desactivada la llamada a los Admins cuando se detecta spam.',
        ...
        'CALL_WHEN_SPAM_NOT_ARG' : \
            ...
            '\n' \
            'Ejemplo:\n' \
            '/cmd_call_when_spam enable\n' \
            '/cmd_call_when_spam disable',
        ...
        'ABOUT_MSG' : \
            'Este es un Bot open-source con licencia GPL-GNU, desarrollado por el usuario de ' \
