...
TEXT = {
    'EN' : {
        'START' : \
            'I am a Bot that fight against spammers users that join groups to publish their ' \
        ...
        'CMD_NOTIFY_ALL' : \
            ...
            'am...\n\nUse the command /notify_discard if you don\'t want to publish it.',

        'CMD_NOTIFY_ALL_OK' : \
            'Message published in all the chats where I am.',

        'CMD_NOTIFY_DISCARD' : \
            'Masive publish discarted.',
    ...
    'ES' : {
        ...
        'CMD_NOTIFY_ALL' : \
            ...
            'estoy...\n\nUtiliza el comando /notify_discard si no quieres publicar nada.',
        ...
        'USER_URL_NAME_JOIN' : \
            'Aviso Anti-SPAM:\n' \
            '————————————————\n' \
            'Un usuario con una URL en su nombre se ha unido al chat.\n' \
            '\n' \
            '"{}" se unió al chat.',
